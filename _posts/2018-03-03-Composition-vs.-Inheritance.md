...
However, this piece of advice must have come from some place of wisdom, so we'll now look at what the benefits of composition are, followed by what some of the drawbacks to composition are, and situations in which inheritance may be a viable alternative.
